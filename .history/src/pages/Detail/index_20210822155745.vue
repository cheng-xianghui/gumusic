                        ...
                        <div class="chooseArea">
                            <div class="choosed">
                                <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                                    ...
                                    <dd class="active" v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" @click="changeisChecked(spuSaleAttr.spuSaleAttrValueList,spuSaleAttrValue)">
