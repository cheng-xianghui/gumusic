<template>
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        placeholder="请输入你的手机号"
         name="phone" 
        v-validate="{requires:true,regex: /^1\d{10}$/}"
         :class="{invalidate:error.has('phone')}" />
  <span class="error-msg">{{errors.first('phone')}}</span>
      ...
      <div class="content">
        ...
        placeholder="请输入验证码"
         name="phone" 
        v-validate="{requires:true,regex: /[0-9,a-z,A-Z]{6}$/}"
         :class="{invalidate:error.has('code')}" />
