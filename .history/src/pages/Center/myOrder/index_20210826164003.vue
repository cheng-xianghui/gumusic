        ...
        <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="(order,index) in myOrderInfo.data..records " :key="order.id">
                <thead>
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">{{order.createTime}}　订单编号：{{order.orderComment}}<span
                ...
                <tbody>
                  <tr v-for="(detail,index) in order.orderDetailList" :key="detail.id">
                    ...
                    <td rowspan="2" width="8%" class="center">{{detail.skuName}}</td>
                    <td rowspan="2" width="13%" class="center">
                      <ul class="unstyled">
                        <li>总金额¥{{order.totalAmount}}</li>
                        <li>{{order.paymentWay==='ONLINE'?'在线支付':'线下支付'}}</li>

                      </ul>
                    </td>
                    <td rowspan="2" width="8%" class="center">
                      <a href="#" class="btn">{{order.processStatus==='UNPAY'?'未支付':'已支付'}}</a>
                    </td>
                    <td rowspan="2" width="13%" class="center">
                      <ul class="unstyled">
                        <li>
