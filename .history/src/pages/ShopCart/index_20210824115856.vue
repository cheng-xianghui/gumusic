...
export default {
  ...
  async  changeCartNum(cart,disNum,flag){
          ...
          try {
             // 发请求修改后台数据
        // await  this.$store.dispatch('getAddshop',{skuId:cart.skuId,skuNum:disNum})getShopCartList
        await  this.$store.dispatch('getShopCartList',{skuId:cart.skuId,skuNum:disNum})
